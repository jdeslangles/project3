...
class MarkersControllerTest < ActionController::TestCase
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post :create, marker: { address: @marker.address, description: @marker.description, latitude: @marker.latitude, longitude: @marker.longitude, name: @marker.name }
    end
  ...
  test "should update marker" do
    put :update, id: @marker, marker: { address: @marker.address, description: @marker.description, latitude: @marker.latitude, longitude: @marker.longitude, name: @marker.name }
    assert_redirected_to marker_path(assigns(:marker))
  end
